...
import { ArrowLeft, Star, BookOpen, ExternalLink, RefreshCw, ChevronDown, ChevronUp } from 'lucide-react';
  ...
  return (
    <div className="h-full flex flex-col md:flex-row max-w-6xl mx-auto w-full md:p-6 p-0 gap-6">
      ...
      <div className="md:w-1/3 w-full bg-slate-50 md:rounded-2xl p-6 flex flex-col border-b md:border-r border-slate-200 md:h-full flex-1 min-h-0 md:shrink-0 overflow-y-auto transition-all duration-300">
        ...
        <div 
            className="mb-4 cursor-pointer md:cursor-auto" 
        ...
        <div className={`${isExpanded ? 'block' : 'hidden'} md:block flex-1 flex flex-col`}>
            ...
            {result ? (
                ...
                <div className="flex-1 hidden md:flex flex-col justify-center items-center text-slate-400 opacity-50">
